  ...
  return (
    <main className="bg-ink">
      ...
      >
        ...
        <div className="relative mx-auto grid max-w-[1360px] gap-8 lg:grid-cols-[.85fr_1.15fr] lg:items-stretch lg:gap-14">
          <Reveal className="group relative min-h-[440px] overflow-hidden border border-gold/30 bg-ink sm:min-h-[560px]">
            <FoodImage
              src={chef.url}
          ...
          <div className="flex flex-col justify-center lg:py-8">
            <SectionHeading
              title={L("خبرة تُقدَّم في كل طبق", "Experience served in every plate")}
            />
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              <Reveal className="border border-gold/25 bg-ink/65 p-5 sm:col-span-3 sm:p-6">
